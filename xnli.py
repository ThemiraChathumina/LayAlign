...
class MPTrainer(pl.LightningModule):
    def __init__(self, trainer_args):
        ...
        model_config = LayAlignConfig(
            ...
            isLayAlign=train_args['isLayAlign']
        )
    ...
    def configure_optimizers(self):
        ...
        optimizer = AdamW(params, lr=self.lr, betas=[0.8, 0.999], eps=1e-8, weight_decay=3e-7)
...
checkpoint_callback = ModelCheckpoint(
    dirpath='/root/LayAlign/',  # Directory to save checkpoints
